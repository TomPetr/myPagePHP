...
$facesPosts = array(
    array(
        ...
        "face" => "b&w.jpg",
        "title" => "B&W Theme",
        "text"  => "I created this theme because I like clean and minimalist Web
    ...
    array(
        ...
        "face" => "squared.jpg",
        "title" => "Squared Theme",
        "text"  => "Creating this theme I experimented how much can be achieved by only using text, couple
    ...
    array(
        ...
        "face" => "funky.jpg",
        "title" => "Funky Theme",
        "text"  => "I have chosen my Funky theme as my main showcase because it... funky. I really enjoyed
