    ...
    <div id="page-wrapper" class="mb-5">
                ...
                <div class="align-self-start collapse navbar-collapse col-6 col-md-9 ml-0 p-0 " id="collapsibleNavbar">
                    <ul id="nav-main-menu"
                        ...
                        <li class="nav-item border-right border-light">
                            <a class="nav-link" href="../../pages/codes.php">codes</a>
                        </li>
                        <li class="nav-item border-right border-light">
                            <a class="nav-link" href="../../pages/apps.php">apps</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="../../pages/faces.php">faces</a>
                        </li>
                    </ul>
                </div>
            </nav>
        ...
        <main id="main-section" class="mb-3 col-12">
            ...
            <div id="columns-3-frame" class="d-flex flex-row flex-wrap">
                <!-- Thumb #1-->
                <a href="../../pages/codes.php" class="d-flex justify-content-around align-items-center mt-0 mb-2 col-12 flex-md-column col-md-4 bg-danger nav-link
